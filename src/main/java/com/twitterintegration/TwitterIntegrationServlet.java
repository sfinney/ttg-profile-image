...
public class TwitterIntegrationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// setHandle(request.getParameter(REQUEST_PARAMETER));
	...
	private void setHandle(String handle) { this.handle = handle; }
	
	private void setTwitterHandle(String twitterHandle) { this.twitterHandle = twitterHandle; }    
}